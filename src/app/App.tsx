...
function HomePage({ currentUser, setCurrentUser, isDarkMode, setIsDarkMode }: { currentUser: any, setCurrentUser: any, isDarkMode: boolean, setIsDarkMode: any }) {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-[#fdfaf8] dark:bg-[#0b0704] ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div
        className="sticky top-0 z-40 md:relative backdrop-blur-sm md:backdrop-blur-none bg-white dark:bg-[#120d09] border-b"
        style={{ height: '64px', borderBottomWidth: '1px', borderBottomColor: isDarkMode ? 'rgba(126,62,21,0.4)' : 'rgba(208,115,57,0.25)' }}
      >
        <div className="flex items-center justify-between gap-4 px-6 h-full">
          ...
          >
            ...
            <h1 className="text-sm font-bold tracking-tight text-black dark:text-[#f7f1ed]">
              Trash Bin
            </h1>
          </div>
          ...
          <div className="absolute hidden md:flex items-center gap-4" style={{ left: 'calc(100vw / 8)', width: 'auto' }}>
            <div className="relative" style={{ width: '520px', maxWidth: 'calc(100vw / 8 * 3)' }}>
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 size-4 text-gray-600 dark:text-[rgba(247,241,237,0.6)]" />
              <Input
                type="text"
                ...
                className="h-10 pl-10 pr-10 border rounded-lg focus:outline-none bg-[#fdfaf8] text-black placeholder-[rgba(16,11,9,0.6)] border-[#eea77a] focus:border-[#d07339] dark:bg-[#18110c] dark:text-[rgba(247,241,237,0.6)] dark:border-[#7e3e15] dark:focus:border-[#c36a32] dark:placeholder-[rgba(247,241,237,0.6)]"
              />
              {searchQuery && (
                <button
                  onClick={() => {
              ...
              {showSearchDropdown && searchQuery && displayMovies.length > 0 && (
                <div className="absolute top-full left-0 right-0 mt-2 border rounded-lg shadow-lg max-h-96 overflow-y-auto z-50 bg-[#fdfaf8] border-[rgba(208,115,57,0.25)] dark:bg-[#120d09] dark:border-[rgba(126,62,21,0.4)]">
                  {displayMovies.slice(0, 8).map((movie) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* 2. Rating • Length • Year */}
                        <div className="text-xs flex items-center gap-1.5 mt-0.5 text-[rgba(16,11,9,0.6)] dark:text-[rgba(247,241,237,0.6)]">
                        ...
                        {/* 3. Genre */}
                        {movie.genre && (
                          <div className="text-xs truncate mt-0.5 text-[rgba(16,11,9,0.5)] dark:text-[rgba(247,241,237,0.5)]">
                            {movie.genre}
                          </div>
                        )}
                      </div>
                  ...
                  {displayMovies.length > 8 && (
                    <div className="p-3 text-center text-sm text-[rgba(16,11,9,0.5)] dark:text-[rgba(247,241,237,0.5)]">
            ...
            <button
              ...
              className="text-sm font-medium cursor-pointer transition-colors tracking-tight whitespace-nowrap text-[rgba(16,11,9,0.6)] hover:text-[#d07339] dark:text-[rgba(247,241,237,0.6)] dark:hover:text-[#c36a32]"
            >
              🎲 Random
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <h1
              className="hidden md:block text-sm font-medium cursor-pointer transition-colors tracking-tight text-[rgba(16,11,9,0.6)] hover:text-[#d07339] dark:text-[rgba(247,241,237,0.6)] dark:hover:text-[#c36a32]"
              onClick={() => {
                setCurrentView('towatch');
                setCurrentPage(1);
              }}
            ...
            <button
              onClick={handleTryMyLuck}
              className="md:hidden text-sm font-medium cursor-pointer transition-colors tracking-tight text-[rgba(16,11,9,0.6)] hover:text-[#d07339] dark:text-[rgba(247,241,237,0.6)] dark:hover:text-[#c36a32]"
            >
              🎲
            </button>
            <h1
      ...
      <header className="w-full md:hidden bg-[#fbf3ee] dark:bg-[#120d09] border-b" style={{ borderBottomWidth: '1px', borderBottomColor: isDarkMode ? 'rgba(126,62,21,0.4)' : 'rgba(208,115,57,0.25)' }}>
        <RecentMoviesCarousel movies={recentMovies} onMovieClick={handleMovieClick} />
      </header>

      {/* Main Content Area - Desktop: Filters + Carousel + Grid */}
      <div className="flex flex-col md:flex-row flex-1 min-h-0 p-0 md:p-6 gap-0 md:gap-6">
        {/* Desktop Filters - Full Height */}
        <div className={`hidden md:block flex-shrink-0 transition-all duration-300 ${isSidebarExpanded ? 'w-[211px]' : 'w-12'}`}>
          <FilterSidebar
            ...
            onCommentClick={handleMovieClick}
            onViewAllComments={() => setShowAllComments(true)}
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Main Content */}
          <main className={`p-4 md:p-5 pb-4 md:pb-5 bg-white dark:bg-[#120d09] border border-[rgba(208,115,57,0.2)] dark:border-[rgba(126,62,21,0.3)] rounded-[10px] ${isDarkMode ? 'text-white' : ''}`}>
      ...
      {/* Footer */}
      <footer className="border-t bg-[#fbf3ee] dark:bg-[#120d09]" style={{ borderTopWidth: '1px', borderTopColor: isDarkMode ? 'rgba(126,62,21,0.4)' : 'rgba(208,115,57,0.25)' }}>
        <div className="flex items-center justify-between px-6" style={{ height: '64px' }}>
          ...
          <span className="text-sm text-[rgba(16,11,9,0.6)] dark:text-[rgba(247,241,237,0.6)]">
